...
(function () {
        ...
        var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
            , d = d.AES = p.extend({
            le1x: function () {
                for (var a = this.K8C, c = a.words, d = a.sigBytes / 4, a = 4 * ((this.Zj3x = d + 6) + 1), e = this.brt0x = [], j = 0; j < a; j++)
                    if (j < d)
                        e[j] = c[j];
                    else {
                        var k = e[j - 1];
            ...
            Cm6g: function (a, b, c, d, e, j, l, f) {
                for (var m = this.Zj3x, g = a[b] ^ c[0], h = a[b + 1] ^ c[1], k = a[b + 2] ^ c[2], n = a[b + 3] ^ c[3], p = 4, r = 1; r < m; r++)
...
function musicEncrpty(id,offset) {
    var i7b = "0CoJUm6Qyw8W8jud";
    var brx0x1 = {"rid":"A_PL_0_"+id,"offset":offset,"total":"false","limit":"20","csrf_token":""};
    // console.log(brx0x1);
    var brx0x2 = "010001";
    var brx0x3 = ""
    var bVj8b = window.asrsea(JSON.stringify(brx0x1), brx0x2, brx0x3, i7b);
    return bVj8b
}
