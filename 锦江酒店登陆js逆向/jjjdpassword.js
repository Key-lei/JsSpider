    ...
    return function() {
            ...
            var p = m.MD5 = c.extend({
                ...
                _doProcessBlock: function(e, n) {
                    ...
                    var c = this._hash.words
                        ...
                        , A = c[3];
                    O = a(O, w, I, A, m, 7, d[0]),
                        A = a(A, O, w, I, p, 12, d[1]),
                        I = a(I, A, O, w, u, 17, d[2]),
                        w = a(w, I, A, O, b, 22, d[3]),
                        O = a(O, w, I, A, g, 7, d[4]),
                        A = a(A, O, w, I, h, 12, d[5]),
                        I = a(I, A, O, w, E, 17, d[6]),
                        w = a(w, I, A, O, f, 22, d[7]),
                        O = a(O, w, I, A, N, 7, d[8]),
                        A = a(A, O, w, I, C, 12, d[9]),
                        I = a(I, A, O, w, y, 17, d[10]),
                        w = a(w, I, A, O, R, 22, d[11]),
                        O = a(O, w, I, A, _, 7, d[12]),
                        A = a(A, O, w, I, M, 12, d[13]),
                        I = a(I, A, O, w, T, 17, d[14]),
                        w = a(w, I, A, O, v, 22, d[15]),
                        O = t(O, w, I, A, p, 5, d[16]),
                        A = t(A, O, w, I, E, 9, d[17]),
                        I = t(I, A, O, w, R, 14, d[18]),
                        w = t(w, I, A, O, m, 20, d[19]),
                        O = t(O, w, I, A, h, 5, d[20]),
                        A = t(A, O, w, I, y, 9, d[21]),
                        I = t(I, A, O, w, v, 14, d[22]),
                        w = t(w, I, A, O, g, 20, d[23]),
                        O = t(O, w, I, A, C, 5, d[24]),
                        A = t(A, O, w, I, T, 9, d[25]),
                        I = t(I, A, O, w, b, 14, d[26]),
                        w = t(w, I, A, O, N, 20, d[27]),
                        O = t(O, w, I, A, M, 5, d[28]),
                        A = t(A, O, w, I, u, 9, d[29]),
                        I = t(I, A, O, w, f, 14, d[30]),
                        w = t(w, I, A, O, _, 20, d[31]),
                        O = o(O, w, I, A, h, 4, d[32]),
                        A = o(A, O, w, I, N, 11, d[33]),
                        I = o(I, A, O, w, R, 16, d[34]),
                        w = o(w, I, A, O, T, 23, d[35]),
                        O = o(O, w, I, A, p, 4, d[36]),
                        A = o(A, O, w, I, g, 11, d[37]),
                        I = o(I, A, O, w, f, 16, d[38]),
                        w = o(w, I, A, O, y, 23, d[39]),
                        O = o(O, w, I, A, M, 4, d[40]),
                        A = o(A, O, w, I, m, 11, d[41]),
                        I = o(I, A, O, w, b, 16, d[42]),
                        w = o(w, I, A, O, E, 23, d[43]),
                        O = o(O, w, I, A, C, 4, d[44]),
                        A = o(A, O, w, I, _, 11, d[45]),
                        I = o(I, A, O, w, v, 16, d[46]),
                        w = o(w, I, A, O, u, 23, d[47]),
                        O = i(O, w, I, A, m, 6, d[48]),
                        A = i(A, O, w, I, f, 10, d[49]),
                        I = i(I, A, O, w, T, 15, d[50]),
                        w = i(w, I, A, O, h, 21, d[51]),
                        O = i(O, w, I, A, _, 6, d[52]),
                        A = i(A, O, w, I, b, 10, d[53]),
                        I = i(I, A, O, w, y, 15, d[54]),
                        w = i(w, I, A, O, p, 21, d[55]),
                        O = i(O, w, I, A, N, 6, d[56]),
                        A = i(A, O, w, I, v, 10, d[57]),
                        I = i(I, A, O, w, E, 15, d[58]),
                        w = i(w, I, A, O, M, 21, d[59]),
                        O = i(O, w, I, A, g, 6, d[60]),
                        A = i(A, O, w, I, R, 10, d[61]),
                        I = i(I, A, O, w, u, 15, d[62]),
                        w = i(w, I, A, O, C, 21, d[63]),
                        c[0] = c[0] + O | 0,
                        c[1] = c[1] + w | 0,
                        c[2] = c[2] + I | 0,
                        c[3] = c[3] + A | 0
        ...
        function(n) {
            ...
            var s = e
                ...
                _doProcessBlock: function(e, n) {
                    ...
                    var d, p, N, C, y, R, _, M, T, v, O = this._hash.words, w = E.words, I = f.words, A = u.words, S = b.words, L = g.words, D = h.words;
                    R = d = O[0],
                        _ = p = O[1],
                        M = N = O[2],
                        T = C = O[3],
                    ...
                    for (var x, s = 0; s < 80; s += 1)
                        x = d + e[n + A[s]] | 0,
                            x += s < 16 ? a(p, N, C) + w[0] : s < 32 ? t(p, N, C) + w[1] : s < 48 ? o(p, N, C) + w[2] : s < 64 ? i(p, N, C) + w[3] : r(p, N, C) + w[4],
                            x = 0 | x,
                            x = l(x, L[s]),
                            x = x + y | 0,
                            d = y,
                            ...
                            p = x,
                            x = R + e[n + S[s]] | 0,
                            x += s < 16 ? r(_, M, T) + I[0] : s < 32 ? i(_, M, T) + I[1] : s < 48 ? o(_, M, T) + I[2] : s < 64 ? t(_, M, T) + I[3] : a(_, M, T) + I[4],
                            x = 0 | x,
                            x = l(x, D[s]),
                            x = x + v | 0,
                            R = v,
                        ...
                        for (var u = 0; u < 5; u++)
                            for (var h = 0; h < 5; h++) {
                                var R = u + 5 * h
                                    ...
                                    , A = p[(u + 1) % 5 + 5 * h]
                                    , S = p[(u + 2) % 5 + 5 * h];
                                l.high = I.high ^ ~A.high & S.high,
                                    l.low = I.low ^ ~A.low & S.low
                            }
                        var l = a[0]
                            , L = d[s];
                        l.high ^= L.high,
        ...
        function() {
            ...
            var d = s.SHA512 = o.extend({
                ...
                _doProcessBlock: function(e, n) {
                    for (var a = this._hash.words, t = a[0], o = a[1], i = a[2], r = a[3], l = a[4], s = a[5], d = a[6], p = a[7], u = t.high, b = t.low, g = o.high, h = o.low, E = i.high, f = i.low, N = r.high, C = r.low, y = l.high, R = l.low, _ = s.high, M = s.low, T = d.high, v = d.low, O = p.high, w = p.low, I = u, A = b, S = g, L = h, D = E, x = f, k = N, B = C, F = y, H = R, P = _, U = M, $ = T, j = v, W = O, G = w, V = 0; V < 80; V++) {
                        var K = m[V];
                        if (V < 16)
                        ...
                        var de = F & P ^ ~F & $
                            ...
                            , ue = I & S ^ I & D ^ S & D
                            , be = A & L ^ A & x ^ L & x
                            , ge = (I >>> 28 | A << 4) ^ (I << 30 | A >>> 2) ^ (I << 25 | A >>> 7)
                            , he = (A >>> 28 | I << 4) ^ (A << 30 | I >>> 2) ^ (A << 25 | I >>> 7)
                        ...
                        W = $,
                            ...
                            L = A,
                            A = Re + Me | 0,
                            I = _e + Te + (A >>> 0 < Re >>> 0 ? 1 : 0) | 0
                    }
                    b = t.low = b + A,
                        t.high = u + I + (b >>> 0 < A >>> 0 ? 1 : 0),
                        h = o.low = h + L,
                        o.high = g + S + (h >>> 0 < L >>> 0 ? 1 : 0),
                        f = i.low = f + x,
                        i.high = E + D + (f >>> 0 < x >>> 0 ? 1 : 0),
                        C = r.low = C + B,
                        r.high = N + k + (C >>> 0 < B >>> 0 ? 1 : 0),
                        R = l.low = R + H,
                        l.high = y + F + (R >>> 0 < H >>> 0 ? 1 : 0),
                        M = s.low = M + U,
                        s.high = _ + P + (M >>> 0 < U >>> 0 ? 1 : 0),
                        v = d.low = v + j,
                        d.high = T + $ + (v >>> 0 < j >>> 0 ? 1 : 0),
                        w = p.low = w + G,
                        p.high = O + W + (w >>> 0 < G >>> 0 ? 1 : 0)
                },
                _doFinalize: function() {
                    var e = this._data
                        , n = e.words
...
function encrapyAES(e) {
    var n = window.CryptoJS.enc.Latin1.parse("h5LoginKey123456")
        , a = window.CryptoJS.enc.Latin1.parse("h5LoginIv1234567")
        , t = e
        , o = window.CryptoJS.AES.encrypt(t, n, {
        iv: a,
...
// var password = '666666'
// var pwdAes = encrapyAES(password)
// console.log(pwdAes)